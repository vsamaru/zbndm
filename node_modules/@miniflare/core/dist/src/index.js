...
async function ensureValidAlgorithm(algorithm) {
...
var generateKey = async function(algorithm, extractable, keyUsages) {
  ...
  return import_crypto.webcrypto.subtle.generateKey(algorithm, extractable, keyUsages);
};
var importKey = async function(format, keyData, algorithm, extractable, keyUsages) {
  ...
  return import_crypto.webcrypto.subtle.importKey(format, keyData, algorithm, extractable, keyUsages);
};
